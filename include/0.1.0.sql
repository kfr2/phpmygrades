ALTER TABLE `grades` ADD `comment` char(255) NOT NULL;
ALTER TABLE `grades` ADD `assign_desc` char(255) NOT NULL AFTER `assign_name`;
ALTER TABLE `grades` ADD `category` INT NOT NULL AFTER `points_scored` ;
CREATE TABLE `posts` (`post_ID` int(11) NOT NULL auto_increment,`topic_ID` int(11) NOT NULL default '0',`poster` int(11) NOT NULL default '0',`timestamp` varchar(10) NOT NULL default '',`body` blob NOT NULL,`deleted` int(11) NOT NULL default '0',PRIMARY KEY  (`post_ID`));
CREATE TABLE `topics` (`ID` int(11) NOT NULL auto_increment,`name` char(50) NOT NULL default '',`class_ID` int(11) NOT NULL default '0',PRIMARY KEY  (`ID`));
